...
export class MessageBroker {
  ...
  onConnectionLostHandlers: Array<Function> = [];
  onConnectionOpenedHandlers: Array<Function> = [];
  ...
  onConnectionLost(callback:Function) {
    this.onConnectionLostHandlers.push(callback);
  }

  onConnectionOpened(callback: Function) {
